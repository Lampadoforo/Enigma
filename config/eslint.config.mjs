...
configStylistic.rules['@stylistic/array-bracket-newline'] = [
	'error',
	{
		minItems: 2,
		multiline: false,
...
configStylistic.rules['@stylistic/arrow-parens'] = [
	'error',
	'as-needed',
];
configStylistic.rules['@stylistic/curly-newline'] = [
	'error',
	'always',
];
configStylistic.rules['@stylistic/function-call-argument-newline'] = [
	'error',
	'consistent',
];
...
configStylistic.rules['@stylistic/max-len'] = [
	'error',
	{
		// To lower to 120
		code: 140,
...
configStylistic.rules['@stylistic/multiline-ternary'] = [
	'error',
	'never',
];
configStylistic.rules['@stylistic/no-extra-parens'] = [
	'error',
	'all',
];
configStylistic.rules['@stylistic/no-extra-semi'] = 'error';
configStylistic.rules['@stylistic/no-mixed-operators'] = 'off';
configStylistic.rules['@stylistic/object-curly-newline'] = [
	'error',
	{
...
configStylistic.rules['@stylistic/object-curly-spacing'] = [
	'error',
	'never',
];
configStylistic.rules['@stylistic/object-property-newline'] = 'error';
configStylistic.rules['@stylistic/one-var-declaration-per-line'] = [
	'error',
	'always',
];
configStylistic.rules['@stylistic/semi-style'] = [
	'error',
	'last',
];
configStylistic.rules['@stylistic/space-before-function-paren'] = [
	'error',
	'never',
];
